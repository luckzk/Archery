...
urlpatterns = [
    ...
    path("pgsql_migration/", pgsql_migration.page),
    path("pgsql_migration/tasks/", pgsql_migration.task_list),
    path("pgsql_migration/tasks/<int:task_id>/", pgsql_migration.task_detail),
    path("pgsql_migration/instances/tables/", pgsql_migration.instance_tables),
    path("pgsql_migration/tasks/create/", pgsql_migration.create_task),
    path("pgsql_migration/tasks/delete/", pgsql_migration.delete_task),
    path("pgsql_migration/tables/scan/", pgsql_migration.scan_tables),
    path("pgsql_migration/sequences/preview/", pgsql_migration.preview_sequences),
    path("pgsql_migration/sequences/apply/", pgsql_migration.apply_sequences),
    path("pgsql_migration/sequences/results/", pgsql_migration.sequence_results),
    path("pgsql_migration/data-check/run/", pgsql_migration.run_data_check),
    path("pgsql_migration/data-check/results/", pgsql_migration.data_check_results),
    path("pgsql_migration/feature-check/run/", pgsql_migration.run_feature_check),
    path("pgsql_migration/feature-check/results/", pgsql_migration.feature_check_results),
    path("pgsql_migration/replica-identity/using-index/", pgsql_migration.set_replica_identity),
    path("pgsql_migration/logs/", pgsql_migration.logs),
    ...
    path("data_dictionary/materialized_view_list/", data_dictionary.materialized_view_list),
    path("data_dictionary/materialized_view_info/", data_dictionary.materialized_view_info),
    path("data_dictionary/sequence_list/", data_dictionary.sequence_list),
    path("data_dictionary/sequence_info/", data_dictionary.sequence_info),
    ...
    path("query/knowledge/", query.knowledge),
    path("query/preference/", query.preference),
    path("query/pgsql_blocking_chain/", query.pgsql_blocking_chain),
    ...
    path("db_diagnostic/cancel_session/", db_diagnostic.cancel_session),
    path("db_diagnostic/tablespace/", db_diagnostic.tablespace),
    path(
        "db_diagnostic/pgsql_tablespace_filters/",
        db_diagnostic.pgsql_tablespace_filters,
    ),
    path("db_diagnostic/trxandlocks/", db_diagnostic.trxandlocks),
    path("db_diagnostic/pubsub/", db_diagnostic.pubsub),
    path("db_diagnostic/pgsql_replication/", db_diagnostic.pgsql_replication),
    path(
        "db_diagnostic/pgsql_replication_slots/",
        db_diagnostic.pgsql_replication_slots,
    ),
    path("db_diagnostic/pgsql_vacuum/", db_diagnostic.pgsql_vacuum),
